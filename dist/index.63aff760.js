...
(0, _uploadJs.upload)("#file", {
    ...
    onUpload (files) {
        files.forEach((file)=>{
            const storageRef = (0, _storage.ref)(storage, `images/${file.name}`);
            ...
            uploadTask.on("state_changed", (snapshot)=>{
                ...
                (0, _storage.getDownloadURL)(uploadTask.snapshot.ref).then((url)=>{
...
},{"firebase/app":"aM3Fo","firebase/storage":"8WX7E","./upload.js":"idLKm"}],"aM3Fo":[function(require,module,exports) {
...
var global = arguments[3];
var process = require("af93fec7460764f5");
const CONSTANTS = {
    /**
...
},{"af93fec7460764f5":"d5jf4","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"d5jf4":[function(require,module,exports) {
...
function quotaExceeded(bucket) {
    return new StorageError("quota-exceeded" /* StorageErrorCode.QUOTA_EXCEEDED */ , "Quota for bucket '" + bucket + "' exceeded, please view quota on " + "https://firebase.google.com/pricing/.");
}
...
function noDefaultBucket() {
    return new StorageError("no-default-bucket" /* StorageErrorCode.NO_DEFAULT_BUCKET */ , "No default bucket found. Did you set the '" + CONFIG_STORAGE_BUCKET_KEY + "' property when initializing the app?");
}
 ...
 */ function invalidRootOperation(name) {
    return new StorageError("invalid-root-operation" /* StorageErrorCode.INVALID_ROOT_OPERATION */ , "The operation '" + name + "' cannot be performed on a root reference, create a non-root " + "reference using child, such as .child('file.png').");
}
/**
...
function isNativeBlobDefined() {
    ...
    return typeof Blob !== "undefined" && !(0, _util.isNode)();
}
 ...
 */ function getBlob$1(...args) {
    ...
    if (BlobBuilder1 !== undefined) {
        ...
        else throw new StorageError("unsupported-environment" /* StorageErrorCode.UNSUPPORTED_ENVIRONMENT */ , "This browser doesn't seem to support creating Blobs");
    }
}
/**
 ...
 */ class UploadTask {
     ...
     */ constructor(ref, blob, metadata = null){
        ...
        this._metadataErrorHandler = (error)=>{
            this._request = undefined;
            if (error._codeEquals("canceled" /* StorageErrorCode.CANCELED */ )) this.completeTransitions_();
            else {
                this._error = error;
                this._transition("error" /* InternalTaskState.ERROR */ );
            }
...
},{"@firebase/app":"3AcPV","@firebase/util":"ePiK6","@firebase/component":"bi1VB","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"idLKm":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["9ZIyz","adjPd"], "adjPd", "parcelRequire39bd")
